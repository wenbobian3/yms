...
<script>
    export default {
        ...
        mounted() {
            ...
            *************************************************/
            // 定义新图标
            var myIcon = new BMap.Icon("https://ss1.bdstatic.com/70cFuXSh_Q1YnxGkpoWK1HF6hhy/it/u=4042124360,2756027725&fm=200&gp=0.jpg",new BMap.Size());
            //创建标注
            ...
            //文字提示
            var label = new BMap.Label('北京市',{offset:new BMap.Size(23,25)});
